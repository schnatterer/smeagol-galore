...
* **Note: Currently working on a the next generation using SCMManager v2, most recent Bitnami Tomcat Version and Java 11.**  
   Check out [scm-v2 branch](https://github.com/schnatterer/smeagol-galore/tree/scm-v2).
